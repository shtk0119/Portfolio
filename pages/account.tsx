            ...
            >
              ...
              <Box width="70%">
                <Box display="flex">
                  ...
                  {isEdit.image && (
                    <Button sx={{ ml: 3 }} onClick={onClickSaveImage}>
                      保存
                    </Button>
                  )}
                </Box>
                <Box display="flex" mt={5}>
                  ...
                  />
                  <Button sx={{ ml: 3 }} onClick={onClickSaveNickname}>
                    保存
                  </Button>
                </Box>
                <Box display="flex" mt={5}>
                  ...
                  />
                  {isEdit.email ? (
                    <Button sx={{ ml: 3 }} onClick={onClickSaveEmail}>
                      保存
                    </Button>
                  ) : (
                    <Button
            ...
            >
              ...
              <Box width="70%">
                <Box>
                  ...
                  />
                  {isEdit.password ? (
                    <Button sx={{ ml: 3 }} onClick={onClickSavePassword}>
                      保存
                    </Button>
                  ) : (
                    <Button
